...
class RiskRecordServiceTest {
    ...
    void getAllRecords_shouldReturnList() {
        when(repository.findAll()).thenReturn(List.of(sampleRecord()));

        List<RiskRecord> list = service.getAllRecords();
    ...
    void getRecordById_shouldReturnRecord() {
        ...
        RiskRecord record = service.getRecordById(1L);
    ...
    void getByStatus_shouldReturnRecords() {
        when(repository.findByStatus("OPEN"))
    ...
    void getByCategory_shouldReturnRecords() {
        when(repository.findByCategory("Infrastructure"))
                .thenReturn(List.of(sampleRecord()));
    ...
    void deleteRecord_shouldDeleteSuccessfully() {
        ...
        verify(repository).delete(any(RiskRecord.class));
    }
